      ...
      if (
        ...
        try {
          ...
          if (texto === '#ff') {
            ...
            // ======================================================
            // DIMENSÕES (melhor enquadramento)
            // ======================================================
            const CANVAS = 512
            ...
            // Se passar do limite
            if (
              textoCitado.length > 230
            ) {
              if (linhas.length > 0) {
                linhas[linhas.length - 1] =
                  linhas[linhas.length - 1].substring(0, 22) + '...'
              }
            }
            ...
            // ======================================================
            // RENDERIZA SVG COM DENSITY (resolve texto em branco)
            // ======================================================
            ...
            // Foto posicionada à esquerda da bolha
            if (fotoCircular) {
              composicoes.push({
                input: fotoCircular,
                top: bolhaY - 10,
          ...
          // density alta + PNG intermediário = texto não fica em branco
          const stickerBuffer =
            await sharp(
              Buffer.from(svg),
              { density: 150 }
